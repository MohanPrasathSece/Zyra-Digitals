                    ...
                    >
                        ...
                        <div className="bg-[#B8860B] px-5 py-4 flex items-center justify-between shrink-0">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border border-white/10 shadow-sm relative">
                                    <div className="w-1.5 h-3 rounded-full bg-black/80 mx-[2px]" />
                                    <div className="w-1.5 h-3 rounded-full bg-black/80 mx-[2px]" />
                                    <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-400 rounded-full border-2 border-white" />
                                </div>
                                <div>
                                    <h3 className="text-white font-bold text-[17px] leading-none">Zyra</h3>
                                    <p className="text-white/70 text-[11px] mt-0.5">Digital Assistant · Online</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                        ...
                        <div ref={scrollRef} className="flex-grow overflow-y-auto px-4 py-5 space-y-5 bg-white scrollbar-hide">
                            {messages.map((msg) => (
                                ...
                                >
                                    <div
                                        className={cn(
                                            "px-4 py-3.5 rounded-[1.4rem] text-[14px] leading-[1.55] whitespace-pre-wrap shadow-sm",
                                            msg.type === "user"
                                        ...
                                        <div className="flex flex-wrap gap-2 mt-1">
                                            {msg.options.map((opt) => (
                                                <button
                                                    ...
                                                    className="px-4 py-2 bg-white border border-gray-200 rounded-[0.9rem] text-[12.5px] font-medium text-gray-600 hover:border-[#B8860B] hover:text-[#B8860B] active:scale-95 transition-all duration-200 shadow-sm"
                                                >
                                                    {opt}
                                                </button>
                                            ))}
