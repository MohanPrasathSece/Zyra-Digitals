...
const Contact = () => {
  ...
  return (
    <div className="pt-20">
      ...
      {/* Hero Section */}
      <AnimatedSection animation="fade-up" className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="font-heading text-5xl sm:text-6xl font-bold text-foreground mb-6">
              Let's Create Together
            </h1>
            <p className="font-secondary text-lg text-muted-foreground mb-8">
              Have a project in mind? Reach out and let's create something exceptional.
            </p>
          </div>
        </div>
      </AnimatedSection>
