...
export const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:hello@zyradigitals.com?subject=Contact from ${encodeURIComponent(
      formData.name
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <p className="text-sm text-muted-foreground text-center">
        ...
        <a href="mailto:hello@zyradigitals.com" className="text-gold hover:underline">
